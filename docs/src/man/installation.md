...
[DNNSP2PT](https://github.com/singularitti/DNNSP2PT.jl).
...
2. Run the following commands and wait for them to finish:
   ...
   julia> Pkg.add("DNNSP2PT")
   ```

3. Run

   ```julia-repl
   julia> using DNNSP2PT
   ```
...
version of DNNSP2PT, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/singularitti/DNNSP2PT.jl"
```
...
our [GitHub repository](https://github.com/singularitti/DNNSP2PT.jl)
for new releases.
Once we release a new version, you can update DNNSP2PT by typing
